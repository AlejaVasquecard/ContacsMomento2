package com.aleja.contactsmomento2;
...
import com.aleja.contactsmomento2.models.ContactsModel;
...
public class CreateContactActivity extends AppCompatActivity {
    ...
    private Button btn__create_contact_create;
    private ContactsModel model;
    protected FirebaseFirestore db;
    private String TAG = "LFNOT";
    final private String colletion = "Contacts";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn__create_contact_create.setOnClickListener(new View.OnClickListener() {
            @Override
